            ...
            <div className="d-flex h-100">
              ...
              >
                <a
                  ...
                  aria-selected="true"
                >
                  <span className="data-hover" data-title="Mission and vision">
                    Mission and vision
                  </span>
                </a>
                <a
                  ...
                  aria-selected="false"
                >
                  <span className="data-hover" data-title="Our challenges">
                    Our challenges
                  </span>
                </a>
                <a
                  ...
                  aria-selected="false"
                >
                  <span className="data-hover" data-title="Technology partners">
                    Technology partners
                  </span>
                </a>
                <a
                  ...
                  aria-selected="false"
                >
                  <span className="data-hover" data-title="Meet the our team">
                    Meet the our team
                  </span>
                </a>
                <a
              ...
              >
                <div className="row">
                  ...
                  <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                    ...
                    <p className="mb-4">
                      Our mission is to be the industry&apos;s premier service
                      provider company concentrated on fulfilling the maximum to
                      our clients.{" "}
                    </p>
                    <h4>
                      <i className="flaticon-eye text-primary me-2" /> Our
                      Vision
                    </h4>
                    <p className="mb-4">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                    <h4 className="mb-4 text-dark">
                      “We take pride in helping our clients deliver marvelous
                    ...
                    <p className="mb-4">
                      We know this in our gut, but what can we do about it? How
                      can we motivate ourselves? One of the most difficult
              ...
              >
                <div className="row">
                  ...
                  <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                    ...
                    <p>
                      We partnered with Technology Managers to increase its
                      skills at every step of the software development process.
                    </p>
                    <div className="row">
                    ...
                    <div className="mt-4">
                      <a className="btn btn-primary-round btn-round" href="#">
                        Become a Partner
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                    <div className="row">
                      <div className="col-12 mb-4">
                        ...
                        <p>
                          Meet our leaders and the hard-working personalities
                          who deliver innovative concepts to corporations like
                          yours.
                        </p>
                      </div>
              ...
              >
                <div className="row">
                  ...
                  <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                    ...
                    <p className="mb-4">
                      There’s always room for intelligent people who are excited
                      about the digital world and are continually looking
                    ...
                    <div className="row mb-4">
                      <div className="col-md-6">
                        <ul className="list list-unstyled">
                          ...
                          <li className="d-flex">
                            <i className="fas fa-check pe-2 pt-1 text-primary" />
                            <span>Full medical benefits </span>
                          </li>
                          <li className="d-flex">
                            <i className="fas fa-check pe-2 pt-1 text-primary" />
                            <span>Pto / vacation</span>
                          </li>
                        </ul>
                      </div>
                      <div className="col-md-6">
                        <ul className="list list-unstyled">
                          ...
                          <li className="d-flex">
                            <i className="fas fa-check pe-2 pt-1 text-primary" />
                            <span>Health, Dental, And Vision</span>
                          </li>
                          <li className="d-flex">
                            <i className="fas fa-check pe-2 pt-1 text-primary" />
                            <span>Collaborative environment</span>
